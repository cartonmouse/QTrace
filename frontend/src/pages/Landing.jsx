      ...
      <header className="sticky top-0 z-40">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-lg font-display font-bold leading-none">QTrace</div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="reveal-item" style={revealStyle(0.04)}>
              <SectionHeading
                label="真实时刻"
                title="那些真正帮上忙的时刻。"
                desc="不是功能清单，而是 QTrace 进入备面日常之后，一次次接住麻烦、记得你、把事情往前推的瞬间。"
              />
            </div>
      ...
      <footer className="border-t border-border/70 px-6 py-10 md:px-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 text-center">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display font-bold">QTrace</span>
          </div>
    ...
    >
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full px-6 text-center">
          <div className="text-sm font-medium text-primary">为什么 QTrace 不只是一个题库？</div>
